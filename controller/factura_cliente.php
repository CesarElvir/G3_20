  ...
  if ($_SERVER['REQUEST_METHOD'] === 'OPTIONS') {
    ...
    header('Content-Type: application/json');
     ...
     switch($_GET["op"]){
        ...
        case "InsertFactura":
            $datos=$facturas->insert_factura($body["NUMERO_FACTURA"],$body["ID_SOCIO"],$body["FECHA_FACTURA"],
        ...
        case "UpdateFactura":
            $datos=$facturas->update_factura($body["ID"], $body["NUMERO_FACTURA"],$body["ID_SOCIO"],$body["FECHA_FACTURA"],
            $body["DETALLE"],$body["SUB_TOTAL"],$body["TOTAL_ISV"],$body["TOTAL"],$body["FECHA_VENCIMIENTO"],$body["ESTADO"]);
